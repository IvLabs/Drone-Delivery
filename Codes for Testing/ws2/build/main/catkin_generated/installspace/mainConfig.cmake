...
if("FALSE" STREQUAL "TRUE")
  set(main_SOURCE_PREFIX /home/anish/ws2/src/main)
  set(main_DEVEL_PREFIX /home/anish/ws2/devel)
  set(main_INSTALL_PREFIX "")
  set(main_PREFIX ${main_DEVEL_PREFIX})
else()
  set(main_SOURCE_PREFIX "")
  set(main_DEVEL_PREFIX "")
  set(main_INSTALL_PREFIX /home/anish/ws2/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'anish <anish@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/anish/ws2/install/${idir}'.  Ask the maintainer 'anish <anish@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/anish/ws2/install/lib;/home/anish/ws2/devel/lib;/opt/ros/kinetic/lib)
